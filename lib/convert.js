/*
node convert.js
By default the member limit on Node js is 512 mb, for larger conversions.
...
node --max-old-space-size=16384 convert.js #increase to 16g
*/
var fs = require('fs');
var finder = require('findit')(process.argv[2] || '../test/jasmine/resources');
    ...
    if(file.indexOf(".dat") > -1 && (file.indexOf(".dat") === file.length - 4)) {
        ...
        function readLines(input) {
          ...
          input.on('end', function() {
            ...
            fs.writeFile(file.substring(0, file.length - 4) + "_" + (lineNum/50000).toString() + ".json", JSON.stringify(jsonFile),function(err){
                if(err) {
